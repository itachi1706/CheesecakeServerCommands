    ...
    public LiteralArgumentBuilder<CommandSourceStack> setExecution() {
        ...
        return builder
                ...
                .then(Commands.literal("lastknownusername")
                        .then(Commands.argument("uuidorname", StringArgumentType.string())
                                .suggests((context, builder) -> SharedSuggestionProvider.suggest(getListOfLastKnownUsernames(), builder))
